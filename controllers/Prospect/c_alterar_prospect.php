...
/**
 * Esta classe é responsável por alterar o prospect no sistema, chamando a controllerProspect e invocando as classes.
 *
 * @author Taylor Lima
 *
 */
...
try{
   ...
   if($result === TRUE ){
        $_SESSION['msgSucesso'] = "Prospect Alterado com sucesso!";
